...
import com.example.news.databinding.RecyclerItemMainBinding
import com.example.news.data.remote.model.Articles

class NewsAdapter : RecyclerView.Adapter<NewsAdapter.NewsViewHolder>() {

    inner class NewsViewHolder(private val binding: RecyclerItemMainBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsViewHolder {
        ...
        val binding = RecyclerItemMainBinding.inflate(inflater,parent,false)
